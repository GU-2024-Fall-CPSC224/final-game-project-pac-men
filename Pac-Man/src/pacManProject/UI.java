...
public class UI {
	...
	public UI (Game gm) {
		try {
			 ft = Font.createFont(Font.TRUETYPE_FONT, new File("res/fonts/Joystix.TTF")).deriveFont(30f).deriveFont(Font.BOLD);
			 tscreenFt = Font.createFont(Font.TRUETYPE_FONT,new File("res/fonts/CrackMan.TTF")).deriveFont(30f).deriveFont(Font.BOLD);
			GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
			ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new File("res/fonts/Joystix.TTF")));
			ge.registerFont(Font.createFont(Font.TRUETYPE_FONT, new File("res/fonts/CrackMan.TTF")));
		}
